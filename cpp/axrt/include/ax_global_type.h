...
typedef enum
{
    ...
    AX_FORMAT_RGB888                                = 0xA1,     /* RGB888 24bpp */
    AX_FORMAT_KRGB444                               = 0xA2,     /* RGB444 16bpp */
    AX_FORMAT_KRGB555                               = 0xA3,     /* RGB555 16bpp */
    AX_FORMAT_KRGB888                               = 0xA4,     /* RGB888 32bpp */
    AX_FORMAT_BGR888                                = 0xA5,
    AX_FORMAT_BGR565                                = 0xA6,

    AX_FORMAT_ARGB4444                              = 0xC5,      /* ARGB4444 */
    AX_FORMAT_ARGB1555                              = 0xC6,      /* ARGB1555 */
    AX_FORMAT_ARGB8888                              = 0xC7,      /* ARGB8888 */
    AX_FORMAT_ARGB8565                              = 0xC8,      /* ARGB8565 */
    AX_FORMAT_RGBA8888                              = 0xC9,
    AX_FORMAT_RGBA5551                              = 0xCA,
    AX_FORMAT_RGBA4444                              = 0xCB,

    AX_FORMAT_BITMAP                                = 0xD0,
